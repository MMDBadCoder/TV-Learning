"""
Django settings for TV_LEARNING project.
...
SECRET_KEY = 'django-insecure-k(ugg63$no1z)90(^caazl(lp#+qn^9&)mt$w&me5^c%zj8v4o'
...
WSGI_APPLICATION = 'TV_LEARNING.wsgi.application'
